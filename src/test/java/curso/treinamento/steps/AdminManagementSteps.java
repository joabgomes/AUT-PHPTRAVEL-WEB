...
public class AdminManagementSteps {
	...
	public void incluo_um_administrador_com_os_valores(String firstName, String lastName, String email, String password, String mobileNumber, String country, String adress1, String address2, String status, String add, String edit, String remove) {
		...
		addAdminPage.preencher_adress1(adress1);
	...
	public void administrador_cadastrado_com_sucesso(String string) {
		Assert.assertTrue("Página Admins Management Não apresentada.", adminsManagementPage.validar_pagina());
