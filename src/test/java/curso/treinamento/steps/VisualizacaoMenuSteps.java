...
public class VisualizacaoMenuSteps {
	...
	public void são_apresentados_os_itens_e(String subMenuAdmin, String subMenuSuppliers, String subMenuCustomers, String subMenuGuestCustomers) {
		
		Assert.assertTrue("Submenu" + subMenuAdmin 	        + "NÃO apresentado.", menuPage.validar_submenu_accounts(subMenuAdmin));
